...
int main()
{
    ...
    printf("\n\nDigite qual o País da sua carta: ");
    scanf("%s", pais1);

    printf("\nDigite as letras que representem um Estado da primeira carta: ");
    scanf("%s", estado1);
    ...
    printf("\nDigite as letras que representem um Estado da segunda carta: ");
    scanf("%s", estado2);
    ...
    // arrumar acentos e escrita aqui abaixo
    //Vamos comparar os atributos com um menu de switch
    ...
    {
    case 1:
        printf("\n\nPopulação da Carta %s: %d\nPopulação da Carta %s: %d\n\n",pais1, populacao1, pais2, populacao2);

        if (populacao1 > populacao2)
        {
            printf("A Carta %s venceu", pais1);
        }
        else if (populacao2 > populacao1)
        {
            printf("A Carta %s venceu", pais2);
        }
        else
        {
            printf("Empate");
    ...
    case 3:
        ...
        // pontos turisticos
    case 4:
        printf("\n\nPontos turísticos da Carta %s: %d\nPontos turísticos da Carta %s: %d\n\n", pais1, pontostur1, pais2, pontostur2);
        ...
        break;
    // dens popul vence carta com menor valor
    case 5:
        printf("\n\nDensidade populacional da Carta %s: %.2f\nDensidade populacional da Carta %s: %.2f\n\n", pais1, densidadepop1, pais2, densidadepop2);
